# Promotion Checklist: srm-generate-invoice
...
| evidence-reviewed | manual_review | Confirm expected result is observable: Generated SAP estimated invoice evidence is captured with invoice number or generation success message after explicit human approval. |
