...
| adapter-capability-reviewed | pass | Capability srmQuerySettlementStatus is declared with status=implemented and required evidence=settlement number, supplier, status, last update or explicit not-found state. |
